...
Failed=失败
files=文件
files uploaded correctly.=个文件上传成功
files were moved.=个文件已移动。
Folder=文件夹
folders=文件夹
forbidden=禁止
Forbidden=禁止访问
...
Logout=登出
Mask=遮罩
max s dl msg=此服务器同时下载数量有限制。<br>目前已达上限。请稍后重试。
Messages=消息
More options=更多选项
Move=移动
Move.=移动
...
Password changed, you'll have to login again.=密码已变更，你需要重新登录。
...
You are banned.=你已被封禁
You must select a single item to rename=你需要先选择单个项目才能重命名
You must select a single item to rename.=你需要先选择单个项目才能重命名
